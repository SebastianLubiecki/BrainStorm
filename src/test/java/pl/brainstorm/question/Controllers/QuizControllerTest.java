...
public class QuizControllerTest {
    ...
    public void getListOfQuizzesWithNumberOfQuestionsGreaterThen() {
        ResponseEntity<QuizEntity[]> response = testRestTemplate.getForEntity(
                "/quiz/listOfQuizzesWithQuestionsGreaterThen/2", QuizEntity[].class
        );
        List<QuizEntity> list = quizRepository.findAllBySizeOfQuestionListGreaterThanEqual(2);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertNotNull(response.getBody());
    ...
    public void getListOfQuizzesSolvedMoreThen() {
        ResponseEntity<QuizEntity[]> response = testRestTemplate.getForEntity(
                "/quiz/solvedMoreThen/2", QuizEntity[].class
        );
        List<QuizEntity> list = quizRepository.findAllByNumberOfSolvedGreaterThanEqual(2);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertNotNull(response.getBody());
